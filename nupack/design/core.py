...
class Specification:
    ...
    def __call__(self, env=None, restart=None, checkpoint_condition=None, checkpoint_handler=None, max_time=0.0, _fun_=None):
        ...
        Arguments:
            ...
            max_time: stop optimization at this wall clock time in seconds. No effect if 0.
